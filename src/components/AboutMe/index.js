    ...
    return (
        ...
        <Container>
            <Grid>
                ...
                <Grid.Column width={9}>
                    <Message>
                        <p className='about-me-message'>Hey!</p>
                        ...
                        <p className='about-me-message'>Like a tale as old as time; I grew older and less involved with the tech community as other life's priorities as well as interests took their hold.
